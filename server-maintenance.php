...
<head>
    ...
    <title>First National Collections Bureau - Payment Server Maintenance</title>
...
<body>
    ...
    <div class="container">
        <div class='section-one'>The Payment Server is temporarily down for maintenance.</div>
    </div>
