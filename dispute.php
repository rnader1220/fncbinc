...
if($_POST) {
    ...
    if(!$valid) {
        ...
        $message = "Your Dispute has been Recieved";
        $success = true;
    }
} else {
                    ...
                    <div class="col-lg-12" id="reason_div">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="reason" id="sel_reason">
                                ...
                                <option value="Verification of Debt">Verification of Debt</option>
                                <option value="Dispute Balance">Dispute Balance</option>
                                <option value="Paid Prior">Paid Prior</option>
                                <option value="Returned Merchandise">Returned Merchandise</option>
                                <option value="Substantiation of Debt">Substantiation of Debt (New York Only)</option>
                            </select>
                        </div>
                    </div>
