<div class="footer">
    ...
    <div class="col-lg-12">
        <div class="company-logos">
            <div class="row justify-content-center gx-4 text-center">
                
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="company d-flex justify-content-center align-items-center">
                        <a class="bbb"
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="company d-flex justify-content-center align-items-center">
                        <span class="aca">ACA International</span>
                    </div>
                </div>

                <div class="col-12 col-md-4 col-lg-3">
                    <div class="company d-flex justify-content-center align-items-center">
                        <a target="_blank" aria-label="RMAi Member - new tab"
                           href="https://rmaintl.org/consumers/" class="rmai">
                           RMAi Member
                        </a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5 fncb">
                            <p>This communication is from a debt collector.<br>This is an attempt to collect a debt and any
                                ...
                                <br>Compliance Manager Certificate ID #: CM100001
            ...
            <div class="row">
                <div class="col-lg-10">
                    <ul>
                        ...
                        <li><a href="/legal-terms.php">Terms and Conditions</a></li>
...
<!-- Google Translate Widget -->
                <div class="col-lg-10">
                    <ul class="socials">
                        ...
                        <li>
                            <!-- a target='_blank' href="https://www.facebook.com/BNCB/" target="_blank"><i class="icon facebook"></i></a -->
                        </li>
                        <li>
                            <!-- a target='_blank' href="https://twitter.com/fncbinc" target="_blank"><i class="icon twitter"></i></a -->
                        </li>
                    </ul>
                </div>
            </div>
